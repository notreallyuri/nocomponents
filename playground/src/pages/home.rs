...
pub fn Home() -> impl IntoView {
    ...
    view! {
        ...
        <main class="flex flex-col gap-4 bg-background h-full">
            <header class="p-4 w-full items-center h-16 flex justify-end bg-muted">
                            ...
                            (trigger_ref, toggle): (AnyNodeRef, Callback<ev::MouseEvent>)|
                        {
                            view! {
                                <button
                                    ...
                                    class="group/avatar relative rounded-none outline-none cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                                >
                                    <div class="hidden absolute inset-0 z-10 group-hover/avatar:block bg-black/20 transition-colors" />
                                    ...
                                    <Avatar class="rounded-none">
                                        <AvatarImage
                                            ...
                                            class="object-cover"
                                        />
                                        <AvatarFallback class="border rounded-none">
                                            "YR"
                                        </AvatarFallback>
                                    </Avatar>
                                </button>
