    ...
    view! {
        ...
        >
            <div class="flex flex-col gap-8">
                <DemoSection title="Confirmation">
                    <Dialog>
                ...
                <DemoSection title="Form" description="A dialog that collects user input.">
                    <Dialog>
                ...
                <DemoSection title="Controlled" description="Open state managed externally.">
                    {
